...
//		cout << origFrame.size() << endl;
//		float scale = .5;
//		int w = origFrame.size().width * scale;
//		int h = origFrame.size().height * scale;
//		resize(origFrame, origFrame, Size(w, h), 0, 0, CV_INTER_AREA);
//		transpose(origFrame, origFrame);
