...
int main(int argc, char *argv[]) {
	...
	while (true) {
        ...
        Mat markedImgOrange;
        Mat markedImgGreen;
		inRange(framecopy, Scalar(0, 120, 44),
				Scalar(30, 256, 256), markedImgOrange);
		inRange(framecopy, Scalar(31, 120, 120),
				Scalar(120, 256, 256), markedImgGreen);
        bitwise_or(markedImgGreen, markedImgOrange, markedImg);
